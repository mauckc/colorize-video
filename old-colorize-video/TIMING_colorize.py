...
if args.input==None:
    ...
    print('Usage example: python3 colorizeImage.py --input greyscaleImage.jpg')
    exit()
...
#outputFile = args.input[:-4]+'_colorized.jpg'
outputFile = 'greyimages/coloredimages/'+args.input[:-4].lstrip('greyimages/')+'_colorized.jpg'
print(outputFile)
time.sleep(0.01)
cv.imwrite(outputFile, img_bgr_out*255)
print('\nColorized image saved as '+outputFile)

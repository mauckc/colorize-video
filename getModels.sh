mkdir models
wget https://github.com/richzhang/colorization/blob/8aa25ac7b6215bf6789e682b6fa3433164d4a3a4/resources/pts_in_hull.npy?raw=true -O ./pts_in_hull.npy
wget https://raw.githubusercontent.com/alexellis/faas-colorization/master/function/models/colorization_deploy_v2.prototxt?raw=true -O ./models/colorization_deploy_v2.prototxt
